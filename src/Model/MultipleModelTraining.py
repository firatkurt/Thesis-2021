...
def train(train_X, train_y, test_X, test_y, le):
    ...
    allEstimators.append(('CustomLGBM', CustomLGBMClassifier(parameters=lgbmParameters)))
    xgBoostParameters = xbt.hyperParameterTune(train_X,train_y)
    allEstimators.append(('CustomXGB', CustomXGBoost(parameters=xgBoostParameters)))
